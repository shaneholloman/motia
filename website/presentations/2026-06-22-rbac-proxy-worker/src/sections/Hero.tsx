 ...
 * the mechanism. A denied call makes the boundary concrete; the stat strip
 * quantifies it.
 */
      ...
      <div className="grid grid-cols-1 @4xl:grid-cols-2 gap-x-16 gap-y-12 px-4 pt-16 pb-14 @3xl:px-9 @3xl:pt-24 @3xl:pb-20">
        <div className="min-w-0">
          <div className="font-mono text-[11px] uppercase tracking-[0.06em] text-ink-faint mb-6">
            <Prompt symbol="$">workers / tech-specs / rbac-proxy</Prompt>
          </div>
              ...
              <TerminalRow
                ...
                output={
                  <span className="flex items-center gap-x-2">
                    <StatusDot pulse />
                    <span>up · :49200 → engine :49134 · rbac on</span>
                  </span>
                }
              />
              <TerminalRow
                command={
                  <>
                    worker-b → invoke <span className="text-ink-faint">api::admin::purge</span>
                  </>
                }
                output={<span className="text-alert">✗ FORBIDDEN &nbsp;&apos;api::admin::purge&apos; not allowed</span>}
              />

...
<Callout type="warn" title="Legacy examples">
  These examples may reflect older patterns. Use them as conceptual references only. For new work, see [iii.dev](https://iii.dev) and [Migrating from Motia.js](https://iii.dev/docs/changelog/0-11-0/migrating-from-motia-js). Reference source: [motia-examples](https://github.com/MotiaDev/motia-examples).
</Callout>

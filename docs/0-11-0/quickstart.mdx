...
<Tip>
  See the full [Console documentation](./console) for details on invoking functions,
...
<CardGroup cols={2}>
  <Card
    ...
    href="./how-to/use-functions-and-triggers"
    icon="book-open"
  >
  ...
  <Card
    title="Concepts"
    href="./primitives-and-concepts/functions-triggers-workers"
    icon="table-layout"
  >

...
| `engine::channels::create`    | Allocate a streaming channel reader / writer pair. The SDK wraps this as the `createChannel` helper (`iii-sdk/helpers`); rarely called directly. |

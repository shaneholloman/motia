...
<Accordion title="REST API Module">
...
<Accordion title="Observability Module">
...
<Accordion title="HTTP Functions Module">
...
```yaml
# Example: run Python motia framework worker
- class: modules::shell::ExecModule
  config:
    watch:
      - ./steps
...
# Example: run Node.js motia framework worker
- class: modules::shell::ExecModule
  config:
    watch:
      - ./steps
...
<Accordion title="Bridge Client Module">
...
<Accordion title="Telemetry Module">
...
<ResponseField name="config.api_key" type="string">
